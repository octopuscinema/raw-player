...
{
    public abstract class VideoFrameRAW : VideoFrame
    {
        public bool Processed { get; protected set; }

        public VideoFrameRAW(GPU.Compute.IContext computeContext, GPU.Compute.IQueue computeQueue, IClip clip, GPU.Format format)
