...
namespace Octopus.Player.GPU.Compute
{
    ...
    public interface IContext : IDisposable
    {
        ...
        IProgram CreateProgram(System.Reflection.Assembly assembly, string resourceName, IReadOnlyList<string> functions, IReadOnlyList<string> defines = null, string name = null);
